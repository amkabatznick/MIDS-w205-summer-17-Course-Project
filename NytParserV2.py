...
for section in sections:
    ...
    article_details = {"article":article_id,"facets":{}}
          ...
          if i[j]:
            ...
            if j == 'per_facet':
              for per in i['per_facet']:
                ...
                facet_details.append(_return_field_details(conn,name,'facet_details'))
            else:
                for facet in i[j]:
                  facet_details.append(_return_field_details(conn,facet,'facet_details'))
            
            article_details['facets'][facet_type_id] = facet_details
