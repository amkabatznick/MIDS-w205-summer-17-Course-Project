                  ...
                  if i[j]:
                    ...
                    if j == 'per_facet':
                        for per in i['per_facet']:
                            ...
                            cur.execute("INSERT INTO article_facet_details (article_id,facet_id,facet_detail_id) Values(%s,%s,%s) ON CONFLICT(article_id,facet_id,facet_detail_id) DO NOTHING",(article_id,facet_type_id,facet_details_id,))
                    else:
                        for facet in i[j]:
